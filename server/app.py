...
# --- I thought this would work, but was getting a consistent 500 error (I tried, but) didn't know how to fix. (Other 10 tests passed, just had this one error) 
# --- I didn't know what else to do (tried resetting/renewing my models and app.db as well) but ended up inputting the to.dict() manually. Ended up passing the pytests but gave two warnings. 
...
def create_restaurant_pizza():
    try:
        ...
        return make_response(pizza_restaurant_data, 201)
    except ValueError:
        return make_response({"errors": ["validation errors"]}, 400)
